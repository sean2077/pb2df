...
_COMPLEXMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[_COMPLEXMESSAGE_SIMPLEMAPFIELDENTRY, _COMPLEXMESSAGE_COMPLEXMAPFIELDENTRY, ],
  enum_types=[
